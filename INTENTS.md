...
## Archive
<!-- research-15 completed 2026-06-18T07:01Z → intents/archive/research-15.md [display: 3D Interactive Character Background Feasibility; projects: personal-ops,infinity; type: research; topics: dashboard,workflow,content] (Sam Samuel 웹의 3D character background + floating HUD 문법은 다음 Status 적용에서는 pre-rendered scene + pointer parallax가 안전하고, 재사용 skill 단계에서는 Three.js/R3F scene + HUD 시스템으로 확장하는 것이 적합하다.) -->
