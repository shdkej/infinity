...
- id: marketing-18
  ...
  priority: high
  permission: L0/L1
  goal: Virtue 공개 사이트/문서가 AI answer engine과 코딩/브라우징 에이전트에게 어떤 제품으로 읽히는지 점검하고, 바로 바꿀 수 있는 내부 문서 항목과 사용자 승인 필요한 공개 변경 항목을 분리한다.
  mode: execute_local
  waiting_for: "로컬 Claude Code 실행 — virtue-rebirth-app/apps/web/docs/aeo-agent-ready-audit.md 작성 및 커밋/푸시"
  context:
    - "artifacts/marketing-18/aeo-agent-ready-audit.md (감사표 완성, llms.txt·JSON-LD·meta 초안 + 로컬 실행 프롬프트 포함)"
    - "virtue-rebirth-app/apps/web/docs/ (최종 문서 위치)"
    - "reports/marketing-18/2026-05-26T0700Z.html"
  last_action: "2026-05-26T07:00Z — cloud 감사표 16개 항목 4분류 완성. 기존 docs/ 9종 충돌 없음 확인. virtue.oracle.shdkej.com 403(prelaunch 보호) 확인."
  next_action: "로컬 Claude Code로 virtue-rebirth-app/apps/web/docs/aeo-agent-ready-audit.md 작성 → 커밋/푸시 → infinity INTENTS.md archive 처리"
