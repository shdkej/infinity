...
### marketing-34: Virtue PLG Foundation exit gate 문서 작성
- **id**: marketing-34
- **status**: in_progress
- **priority**: medium
- **permission**: L1
- **project**: virtue
- **goal**: PLG Handbook Foundation→Activation 단계 모델을 Virtue prelaunch에 적용해, 출시 후 첫 10~20명 또는 7일 관찰 시 activation bundle·D7 second value·source promise fit을 한 기준으로 읽게 하는 Foundation exit gate 체크리스트 문서를 `apps/web/docs/`에 추가한다.
- **success_criteria**:
  - `apps/web/docs/plg-foundation-exit-gate.md` 신규 1파일 추가
...
- **context**:
  - `apps/web/docs/` (virtue-rebirth-app)
  - activation-candidate-registry.md (marketing-33), first-real-user-baseline-template.md (marketing-11), time-to-value-observation-brief.md (marketing-10), first-week-activation-retention-bridge.md (marketing-14), onboarding-metrics-reading-table.md (marketing-23), retention-predictive-activation-brief.md (marketing-22), traffic-source-reading-boundary-table.md (marketing-25)
  - 출처노트: source/external-links/marketing/2026-06-02-plg-foundation-phase-gate.md
- **started**: 2026-06-02
- **next**: 로컬 Claude Code에서 `artifacts/marketing-34/plg-foundation-exit-gate-draft.md`를 virtue-rebirth-app `apps/web/docs/plg-foundation-exit-gate.md`에 반영 후 커밋·push
