...
- active_task: T6.1 마감 전 최종 증거·HTML 보고·원격 검증 (active 2026-09-08T12:53:13Z)
- next_decision: T6.1에서 명시된 final report·Red 결과·원격 증거를 수렴한다. Archive 전이는 별도 terminalization cycle에서만 검토한다.
