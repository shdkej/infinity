...
- active_task: none — 모든 leaf 완료; terminalization review pending
- next_decision: Archive 계약은 final report·Red PASS·closing remote proof·지식 판정을 별도 terminalization cycle에서 확인한다.
