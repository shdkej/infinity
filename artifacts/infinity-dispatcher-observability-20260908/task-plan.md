...
`마감: 2026-09-09 08:00 Asia/Seoul / 2026-09-08T23:00:00Z` · `실행: 2회차` · `태스크: 6개 중 3개 완료 · 3개 미완료`
...
│  ◐ T2.1 구현 · leaf: true · 진행 · 예상/최대 30/30분 · 의존 T1.3
...
**지금 다음 행동:** `T2.1에서 명시된 read-only exporter·scrape·dashboard fixture를 구현한다.`
