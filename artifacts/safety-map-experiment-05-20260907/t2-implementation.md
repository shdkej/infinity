...
- 배포: Space `4dca65e` + 초기 클릭 보정 `1b62d28` + 시작/영역 클릭 복구 `89c13b5`, `fac1050`
- GitHub Actions: run `34129702370`, `34130483439`, `34130680579` 성공
- 재작업: Mapbox가 완전히 준비된 뒤에만 레이어를 설치하고, 지도 클릭은 레이어 이벤트가 아닌 Termini 넓은 범위 판정으로 처리했다. 지도 초기 연결 전에도 근거 drawer를 열 수 있는 제한적 fallback을 넣었다.
- 라이브에서 영역 클릭 후 drawer와 3개 출처 링크를 확인: 2026-09-07T14:11:20Z
