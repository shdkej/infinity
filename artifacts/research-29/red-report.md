...
- red_status: blocked
- blocker: Red subagent environment could not start a shell process; requested files and remote commits could not be independently verified.
- next_retry_condition: retry Red from a filesystem-capable environment before Archive or promotion completion.
