...
│  ○ T5.3  Slack 종료 알림 delivery receipt 확인                    T6.2 완료 뒤 · 10분/최대 20분
│
○ T6  마감 전 품질 반복                                               T5.2 완료 뒤
   ○ T6.1  디자인 품질 반복                                          T5.2 완료 뒤 · 30분/최대 45분
   ○ T6.2  모바일 접근성 반복                                        T6.1 완료 뒤 · 30분/최대 45분
...
**지금 다음 행동:** T6.1을 먼저 Active로 전환해 디자인 품질 반복을 수행합니다. T6.1 완료 전 T6.2는, T6.2 완료 전 T5.3은 시작하지 않습니다.
