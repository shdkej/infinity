...
따라서 실제 원자료 없이 작성된 내용은 **분석 근거로 재사용하지 않는다.** 실제 최신 4개 Threads 글과 반응값이 들어온 뒤 새 final artifact를 작성한다.
...
REDACTED_INVALIDATED_CONTENT: 실제 Threads 4개를 보지 못한 상태에서 작성된 추정 내용은 삭제했다. 후속 작업은 이 문서를 분석 근거로 쓰지 않는다.
