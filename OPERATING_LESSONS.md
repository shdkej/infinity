...
- 이 파일에는 Infinity intent 처리 교훈만 남긴다. 둘 이상 시스템(OpenClaw·Knowledge Lab·Infinity)에 적용되는 규칙은 정본인 `/home/ubuntu/workspace/knowledge-lab/source/openclaw-system/docs/OPERATING_LESSONS.md`로 승격하고 여기엔 포인터만 둔다. 위키 편집 교훈은 `../logs/OPERATING_LESSONS.md`에 있다.
