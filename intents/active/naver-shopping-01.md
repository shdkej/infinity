...
- 2026-06-14T0404Z **소싱-퍼스트 스크린 라운드 2 (cloud research).** 상위 2개 후보(포토 포켓 앨범, 다꾸 스티커)의 소싱 경로·단가·마진 구조 조사. **포토 앨범:** MOQ 50~300pcs, 소싱 단가 ₩2,500~₩4,000, 추정 마진 30~50%, 핵심 위험 = K-pop 카테고리 노이즈(`포켓 앨범` → `여행 앨범` 키워드 분리 필요). **다꾸 스티커:** 단가 ₩800~₩2,000/팩, 추정 마진 30~45%, 소량 커스텀 인쇄(퍼블로그 등)로 무재고 진입 가능, 핵심 위험 = 경쟁 과밀. 두 후보 모두 소싱 용이성 확인, **DataLab 수요 검증이 다음 1순위.** DataLab/Naver Shopping 접근 없음(로컬 세션 필요). 라이브 상품등록/가격·배송·재고/광고·고객·주문·계정·공개발행 0. 산출물: `artifacts/naver-shopping-01/sourcing-round2-research-2026-06-14.md`, 리포트: `reports/naver-shopping-01/2026-06-14T0404Z-research.html`.
