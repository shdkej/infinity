...
마케팅/세스고딘 작업은 알림을 작업당 1개로 압축한다. 후보 발굴, Inbox 등록, 학습 노트 저장처럼 실행 전 준비 단계는 커밋·push로 기록하되 Telegram에는 보내지 않는다. 사용자에게 보낼 알림은 완료, 승인 필요, blocker/Waiting 전환처럼 다음 판단에 필요한 최종 요약 1개만 남긴다.
